...
// DeleteStaleContainerRuntimeResources deletes unused container runtime rsources from the shoot namespace in the seed.
...
// WaitUntilContainerRuntimeResourcesDeleted waits until all contaienr runtime resources are gone or the context is cancelled.
